...
public struct SteamPressFluentMysqlProvider: Vapor.Provider {
    ...
    public func register(_ services: inout Services) throws {
        ...
        services.register(FluentMysqlTagRepository(), as: BlogTagRepository.self)
        services.register(FluentMysqlUserRepository(), as: BlogUserRepository.self)
        services.register(FluentMysqlPostRepository(), as: BlogPostRepository.self)
